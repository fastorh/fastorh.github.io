...
export default function LoginPage() {
  ...
  const onSubmit = async (data: FormData) => {
    ...
    try {
      ...
      const code = axiosErr.response?.data?.error ?? 'UNKNOWN';
      const message = axiosErr.response?.data?.message ?? 'Error al iniciar sesión';
              ...
              <div className="rounded-lg bg-red-50 border border-red-200 p-3">
                ...
                {authError.code === 'EMAIL_NOT_VERIFIED' && (
                  <button
                    ...
                    className="text-red-700 text-xs font-semibold underline mt-1"
                  >
