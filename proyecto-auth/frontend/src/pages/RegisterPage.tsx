      ...
      <div className="min-h-screen bg-gradient-to-br from-indigo-50 to-white flex items-center justify-center p-4">
        <div className="bg-white rounded-2xl shadow-xl p-8 max-w-md w-full text-center">
          ...
          <p className="text-gray-500 mb-6">
            Enviamos un enlace de verificación a <strong className="text-gray-700">{registered}</strong>
          </p>
          <button
            onClick={handleResend}
            disabled={cooldown > 0}
            className="w-full border border-gray-300 rounded-lg py-2.5 text-sm font-medium text-gray-700 hover:bg-gray-50 disabled:opacity-50 disabled:cursor-not-allowed transition"
          >
            {cooldown > 0 ? `Reenviar en ${cooldown}s` : 'Reenviar email'}
          </button>
          <button onClick={() => setRegistered(null)} className="mt-3 text-sm text-gray-400 hover:text-gray-600 underline">
      ...
      <div className="w-full max-w-md">
        <div className="bg-white rounded-2xl shadow-xl p-8">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-500 text-sm mt-1">Gratis para siempre</p>
          </div>
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center text-sm"><span className="bg-white px-3 text-gray-500">o regístrate con</span></div>
          </div>

          <button
            onClick={loginWithGoogle}
            className="w-full flex items-center justify-center gap-3 border border-gray-300 rounded-lg py-2.5 text-gray-700 font-medium hover:bg-gray-50 transition"
          >
            <GoogleIcon />
